        ...
        <div>
          <div style={{ display: "flex", gap: 6, marginBottom: 14 }}>
            {[["all","Tümü"], ["pending","Bekleyen"], ["replied","Yanıtlandı"]].map(([val, lbl]) => (
              <button key={val} onClick={() => setFilter(val)} style={{ padding: "5px 12px", borderRadius: 6, border: "1px solid #1e293b", background: filter === val ? "#2563eb" : "#0d1117", color: filter === val ? "#fff" : "#94a3b8", fontSize: 12, cursor: "pointer" }}>
