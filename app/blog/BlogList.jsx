"use client";
// ─────────────────────────────────────────────────────────────────────────────
// BlogList — blog liste sayfasının interaktif katmanı (arama + etiket filtresi).
//
// initialPosts sunucudan gelir → ilk HTML'de makale başlıkları, özetleri ve
// linkleri bulunur. Dil değiştirilirse eski davranış korunur: /api/blog
// yeniden çağrılır. Görsel çıktı değişmemiştir; tek fark, ilk yüklemede
// spinner yerine içeriğin doğrudan görünmesidir.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function BlogList({ initialPosts = [], initialLang = "tr" }) {
  const { lang } = useLang();
