export const PLANS = {
  free_trial: {
    ...
    duration: 7,
    maxCalculations: 20,
    tools: ["grain-size", "corrosion", "phase-diagram", "hardness", "unit-converter", "sem-eds", "dbtt", "carbon-equivalent"],
    exports: ["csv"],
    apiAccess: false,
  },
  starter: {
    ...
    price: 5,
    maxCalculations: 50,
    tools: ["grain-size", "corrosion", "hardness", "unit-converter", "sem-eds", "dbtt", "carbon-equivalent"],
    exports: ["csv"],
    apiAccess: false,
  },
  professional: {
    ...
    tools: ["grain-size", "corrosion", "phase-diagram", "hardness", "unit-converter", "sem-eds", "dbtt", "carbon-equivalent", "inclusion"],
...
export const TOOLS = [
  ...
  },
  {
    ...
    shortName: "SEM-EDS",
    description: "SEM-EDS spectrum peak overlap analysis and metallurgical interpretation.",
    icon: "\ud83d\udd2c",
  ...
  },
  {
    ...
    name: "Carbon Equivalent Calculator",
    shortName: "CE Calc",
    description: "CE(IIW), CET, Pcm, CEN weldability assessment and preheat estimation.",
    icon: "\ud83d\udd25",
    tags: ["CE(IIW)", "Pcm", "EN 1011-2", "Preheat"],
    status: "live",
    route: "/tools/carbon-equivalent",
  },
  {
    id: "inclusion",
