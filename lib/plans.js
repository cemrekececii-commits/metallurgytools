...
export const PLANS = {
  free_trial: {
    ...
    duration: 7,
    maxCalculations: 20,
    tools: ["grain-size", "corrosion", "phase-diagram", "hardness", "unit-converter"],
    exports: ["csv"],
    apiAccess: false,
  },
  starter: {
    ...
    price: 5,
    maxCalculations: 50,
    tools: ["grain-size", "corrosion", "hardness", "unit-converter"],
    exports: ["csv"],
    apiAccess: false,
  },
  professional: {
    ...
    tools: ["grain-size", "corrosion", "phase-diagram", "hardness", "unit-converter", "dbtt", "inclusion"],
...
export const TOOLS = [
  ...
  },
  {
    ...
    description: "Multi-environment corrosion rate estimation for carbon and low-alloy steels.",
    icon: "⚗️",
  ...
  },
  {
    ...
    description: "ASTM E140 uyumlu sertlik ölçeği dönüşümü. HRC, HRB, HV, HB ve yaklaşık çekme dayanımı.",
    icon: "🔧",
  ...
  },
  {
    ...
    description: "Metalurji mühendisliğinde kullanılan birimler arası dönüşüm. Gerilme, kuvvet, enerji, sıcaklık.",
    icon: "📐",
    tags: ["MPa-ksi", "J-ft·lb", "°C-°F", "Engineering"],
    status: "live",
